...
MONTGOMERY_PLACES = [
    ...
    # ── ADDITIONAL RESTAURANTS ────────────────────────────────────
    {
        ...
        "name": "Brick & Tin",
        "category": "Restaurant",
        "subcategory": "Café & Sandwiches",
        "address": "221 Montgomery St, Montgomery, AL 36104",
        "neighborhood": "Downtown",
        "description": "Montgomery's beloved neighborhood café known for creative sandwiches, fresh salads, and house-made soups. Locally sourced ingredients, cozy industrial-chic atmosphere, and one of the best lunch spots downtown. A true Montgomery staple with a loyal local following.",
        "hours": "Mon-Fri 10:30am-2:30pm",
        "price_range": "$$",
        "points": 125,
        "photo_ref": "ATCDNfULNWy8dJrPj-Dp_3OQvOeh8wJQ_gyeGV5sFdj9BAWq5TrtNsRytsPZ2Rsab0wONmF4tT293VyOt7Y59Qk1HiViG9QyMJfhSs9LB6eHq0xay7EChmiGGb4lmKPD6v_-ntZmvUVLnS4E4QSR4LQoY1XVchuzdMRJg0zjQL0jEObycsUEeKiA4Za5aqyfyU2WzKKkH-j9cWivyaF8qCSrqPv8R0h2qwyH1j9VIjVWDm1am9c_hBC27J5qVWvN_QgedzrakGlXFM4u6k7Xbb2PQZQ6Pxsh0R-lreNLX-CxBEWu4q7_K-1XMCvNurC6EdcOeEWLgrnwGn3l6LCIfZP2KDOiIu7Qh1J_ltQ1az__Ps1_UTcaw4BH27weV7Ekeve0s57vZ-kph4zIkH1erYyeEICIX6o1or2I5MjjPbhuBnJQCbdl0-DRRVnVobQeo9wgLCzLOq7A6al3n4rjGUi4sEydEsfZFU93I-VKYxfW14GfjUFd3Gk49mRQ1O1FA_orM_j6Qa4tguSubp1c-BBdAhi0vG1WGzheO_fnHspMTVv9fxpxFTe4Ffi4dM1_FtJ2YlL_HkYb",
        "tags": ["lunch", "sandwiches", "salads", "local favorite", "casual", "downtown"],
    },
    {
        "id": "rest_008",
        "name": "Niffer's Place",
        "category": "Restaurant",
        "subcategory": "American Comfort Food",
        "address": "2280 Taylor Rd, Montgomery, AL 36117",
        "neighborhood": "East Montgomery",
        "description": "A beloved Montgomery institution serving comfort food classics since 1996. Famous for their massive burgers, loaded potato skins, and cold beer. The quintessential neighborhood hangout with a warm, welcoming vibe and sports on every screen.",
        "hours": "Mon-Sun 11am-10pm",
        "price_range": "$$",
        "points": 125,
        "photo_ref": "ATCDNfXjPOfevhrftExdmKV0ZyiNDJY4VIvMsu1VdNXzzFKrvCPSvbRLwTxH7Fm74lRi6gWwWv9f9uuGrzBr253pqXI7jXaaBmoVicF7riQc521ytI-hylMk8KGQXL0V4BQ2xx09_kXrBRLVV8zzossQV00yOa8HLghpuW8HPQhpEUVJVIyUvkbVCc1cwWXTXW6bwY1XEzOGPxfSCaBis6Ao1X0c3eMFXIi_bd6T0VF4Q2bporGz3cfuJ7rQP7dytdNjeJzQNPdJ3AKmuu5tetQdBL42pJwq4H8jjZK4RmGg7RFIw8pSPz3jUsS31T2orYzfXIdaw_eNi7m5eNWqffDJku4NTL5PofsDWoC_wdIa9fSRASfNPkEnZmgfwMzFrxDin6NrLpJ9eZJcMVEcUUbDhZXarMAqrm9hwBo74M55UYLC1Cdqo2gzYM2geYXQ9loIYw_57MgiwYCy6mzRzJdj8Py1E7FT8NKbNOrJl1PB3PTAf7PgCg5IgDrnfDIeU6ek8LOUOrEcHuudpYrk_-2LShY1eEJx0e9BkmG4_5XYzX9u6Qr679DaKfAal4M4JQ7gQKrzOGjF",
        "tags": ["burgers", "comfort food", "casual", "sports bar", "neighborhood", "local favorite"],
    },

    # ── ADDITIONAL BARS ───────────────────────────────────────────
    {
        "id": "bar_004",
        "name": "The Vine Wine Bar",
        "category": "Bar",
        "subcategory": "Wine Bar",
        "address": "Cloverdale Plaza, Montgomery, AL 36106",
        "neighborhood": "Cloverdale",
        "description": "Intimate wine bar in the charming Cloverdale neighborhood. Curated selection of 150+ wines by the glass or bottle, charcuterie boards, and artisan cheeses. Perfect for a sophisticated night out. Live acoustic music on Fridays and Saturdays.",
        "hours": "Tue-Thu 4pm-10pm, Fri-Sat 4pm-midnight",
        "price_range": "$$$",
        "points": 175,
        "photo_ref": "ATCDNfWXTsuCuobclmoXzyi23y6cpKnVRRv9tOX6_xqjBGy1f73P4Ki7QZxr1w-nld9E9I-QUGSzBfpIuCj_WT71u_ihOlqRuf1lxjawmnJJMfz0_lVbEdWmk9Zadkd7SAKqlxLsRYt4Rs7fINdzM_jDm5lm398DsZYBM5gyg3ZDj1vrOAeb9Z3Xi8gJX6F7yRr5wRDxsbCMPHja90bfxe3Btobh2Vs7fYz7bcC8jVb7Ch1MnC2OctXJoXkwXWSbCjAs73RbZCOsEKdprpHnlbvQ_-o78bNe7xdAU6LcS0Tlw8cEtMQzpdAUXdMCFk-Z0sGWRP_dQmGGAjsE_p02BgcCEt4V02a1UTqx347mzvDGGJSWRHUb0lKR7woGXkGbcU459pzz0d---mnVyrZpiQRtdBdOgjXNjFjUkqtgS9hoIcMfGNCmunj8rgnbGv6jPHrHCHImAUiDmC9EdFo6ZKIpi4Y5PE6519byA-TQ1pmYz8AamPg0DQzeX4_9iu0ziXlJctIZfQ94yZGE0LO65doLQZv3ZTm7b7zU6UpFy8ZGRAdryfZ4164LCrbG4R3oy6NL-vmi69-pXrEHLHH75qjVD4bYPBCenA",
        "tags": ["wine", "upscale", "live music", "date night", "intimate", "cloverdale"],
    },

    # ── ADDITIONAL ATTRACTIONS ────────────────────────────────────
    {
        "id": "attr_009",
        "name": "F. Scott & Zelda Fitzgerald Museum",
        "category": "Attraction",
        "subcategory": "Literary Museum",
        "address": "919 Felder Ave, Montgomery, AL 36106",
        "neighborhood": "Cloverdale",
        "description": "The only museum in the world dedicated to F. Scott Fitzgerald and his wife Zelda, who was born in Montgomery. Housed in the home where they lived in 1931-32 while Fitzgerald wrote Tender Is the Night. Features original artwork, manuscripts, letters, and personal artifacts.",
        "hours": "Wed-Fri 10am-3pm, Sat 10am-5pm, Sun 1pm-5pm",
        "price_range": "$",
        "points": 225,
        "photo_ref": "ATCDNfW3ffJa08IiWqZZLc8o5BY0Pd6NGTygmrT-xWS-AOobRDh-7yf7UxCLvCMHJxmJEayMOzzaM7jIqFDD209T4841V5MxLQtrlsMH3gFBgQwj1uLU4pF8GU0IXTD26Eifj7mvC52mRek4_VdqM2eFpZG77DwR20ogqEFGNdvBaHv7gyregX5UfEy58S4qEISf-uSwRPFCyYtyZSXgy0ZnGHjKsYKbRCN3DTw8-EYZiE9HkvF2FAr3PWUmNTZimkKkuEp4AtL8N_HhjGeFGEYrQc9CBCfrxE1bHqC2psNUPAMJrw0hfcx_JDf0YK18-luA-zfTZWntpWbsVdXxdgpI2Ds-PasqgsZM_LRDgrQcB4SqvjLrdaoWM1U3bovPupFwFsQEXxHwsmSNIipPzddVSPQ92_H84UB81uYH8_fvpy2hYSa8JBCbZGMuVh_vcqAvOa4e2u9QNcs-VZwB4YukkEDq70QGt834NqsVvlsSFRsYR7Sw2U-zsA-BFOXR9k_Ybcei7lBx0ezFsm-MFyb6Bs8eKzGdrJORM0S5QMBI5MtbK-ZHKk1rIotsyuPLBWkrQ8-lVGxe",
        "tags": ["museum", "literary", "history", "arts", "zelda", "cloverdale", "unique"],
    },
    {
        "id": "attr_010",
        "name": "Old Alabama Town",
        "category": "Attraction",
        "subcategory": "Living History Museum",
        "address": "301 Columbus St, Montgomery, AL 36104",
        "neighborhood": "Downtown",
        "description": "A six-block living history museum featuring over 50 restored 19th-century structures. Costumed interpreters bring Alabama's past to life in an authentic 1800s neighborhood. Includes a one-room schoolhouse, country store, doctor's office, and plantation-era buildings.",
        "hours": "Mon-Sat 9am-4pm",
        "price_range": "$$",
        "points": 200,
        "photo_ref": "ATCDNfWSoZdEyrGQtoesFNtFbpdqbJLm8m7Xn8WfdlRGEnPzajqIg4tJoqTcw4fYCR7LYLWfD5tOpFWMc5-RNVvbRXiZn_xix2CB0IurA8FgNV-jWjdxLp3F-JMm5EZjYTMMqs0PQ2fao4OnGM0TJyZCkD_FZRs5itqpgf_BGdQk-j_XfDGnot-7C28MaYbOumU4nkoXme8F-pe8IFjo5RcMvcOedRKPg9tdRKs9UwO65rMv46nFmf8PChrj73RbKGG2A_KEKfOvJLn4PmHnxjoIUTy-M9zcgN14hjibNSsYAbpsmahfV9z-n8r_xwOpfwlkZbfPoLx3nQSW3yV_mxkODARCz6Dftor5btgaCzz42nlsyJMuX6ObimT6Ga6ilAwD6rpJgr4cyf5REuBl3GoiG0oQ2hA89KB9I6csmbv7oS0ZYGDtSnZPDaFUOfLFT_UDJpifW1akF6-dJN2K3Vbsk-uBZK4YnqAVlJTurBICPL-FtQoJEDIFPfOOCaUTc78s1gJJF-SzSQIDnqjBiHoKBVQuy181OjxzzGaoJYzejNEdPKpmN2pi1nw6Q0CYbBBWCghKXvPhFp-sWA",
        "tags": ["history", "living museum", "educational", "19th century", "walking tour", "family-friendly"],
    },
